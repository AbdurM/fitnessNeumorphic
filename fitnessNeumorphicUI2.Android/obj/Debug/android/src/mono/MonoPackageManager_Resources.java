...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "fitnessNeumorphicUI2.Android.dll" comes first in this list. */
		"fitnessNeumorphicUI2.Android.dll",
		"fitnessNeumorphicUI2.dll",
		"FormsViewGroup.dll",
		"SkiaSharp.dll",
